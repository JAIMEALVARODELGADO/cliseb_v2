...
$link=conectarbd();
$consulta="select iden_ucs,nomb_ucs,logi_ucs,clav_ucs,tipo_ucs
                          from u_cliseb where codi_ucs='$_GET[codi_ucs]'";
echo $consulta;
...
<input type='text' name='codi_ucs' value='<?php echo $_GET['codi_ucs']?>'>

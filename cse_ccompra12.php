...
<table class='Tbl0' width='100%' border='0'>
  <tr>
	...
	<td class='Td2' width='10%' align='left'><input type='text' name='nrod_cli' size='10' maxlength='20' onblur='recarga()' value='<?echo $nrod_cli;?>'></td>
	<td class='Td2' width='10%' align='right'>Nombres:</td>
    <td class='Td2' width='20%' align='left'><input type='text' name='nomb_cli' size='25' maxlength='25' value='<?echo $nomb_cli;?>' <?echo $disp;?>></td>
	<td class='Td2' width='10%' align='right'>Apellidos:</td>
	<td class='Td2' width='40%' align='left'><input type='text' name='apel_cli' size='25' maxlength='25' value='<?echo $apel_cli;?>' <?echo $disp;?>><a href='#' onclick='buscar()'><img src='img/32px-Crystal_Clear_app_xmag.png' border=0 height='20' width='20' alt='Buscar'></a></td>
  </tr>
</table>
...
$consulta="SELECT codi_cli,nrod_cli,nomb_cli,apel_cli,dire_cli,tele_cli FROM cliente";
if(!empty($condicion)){
